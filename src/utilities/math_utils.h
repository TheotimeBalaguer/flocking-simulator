...
/* With a vector with its values associated with the rows of a matrix (v[x] associated with m[x][:]),
  sort the vectors in ascending order and keep the correspondance of the rows of the associated matrix */
...
/* Returns the sum of all components of a vector (int) */
int InnerSum(int *InputVector, int Dim);

/* Returns the sum of all components of a vector (double) */
...
/* Gives the distance of two points in 3D */
...
/**
 * @return the value of the adjacency potential function at distance d
 * between two particles with given parameters
 */
...
/**
 * @return the gradient of the adjacency potential function at distance d
 * between two particles with given parameters
 */
